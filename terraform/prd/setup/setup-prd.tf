...
terraform {
  backend "s3" {
    ...
    key            = "sg738-fav-color-ui/prd/setup.tfstate" // TODO replace <APP_NAME>
    region         = "us-west-2"
  }
  required_providers {
    aws = {
...
locals {
  app_name = "sg738-fav-color-ui-prd" // TODO replace <APP_NAME>
}
...
module "setup" {
  ...
  tags = {
    ...
    repo             = "https://github.com/byu-oit/sg738-fav-color-ui" // TODO Update REPO_NAME
    app              = local.app_name
  }
}
